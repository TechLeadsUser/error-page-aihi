  ...
  return <section className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          return <div key={destination.title} className="group relative bg-card rounded-2xl p-6 shadow-card hover:shadow-elevated hover:-translate-y-1 transition-all duration-300 border border-border/50 hover:border-primary/30">
                ...
                <Link to={destination.href} className="absolute inset-0 rounded-2xl" aria-label={`Visit ${destination.title}`} />
              </div>;
        })}
        </div>
